"""
Comparing performance across noise regimes.
- Train a model with noise_std = 0 and another with noise_std = 0.1 or 0.01.
- For each of these configurations, measure performance when noise is present and when it is not.

Expected output graph:

|-------------------|------------------|
|                   |                  | SNR_i = 20dB or something
|                   |                  | 
|                   |                  |
|                   |                  |
|-------------------|------------------|
...
|                   |                  |
|-------------------|------------------|
 SNR_t = infty          SNR_t = 20dB or something
...
def train(
    ...
    noise_std_arr = configs['noise_std_arr'] # should only have two elements, 0 and 0.1 or 0.01
