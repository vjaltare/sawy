"""
Training a parameter-matched FFN with sigmoidal activation on UCI Dataset for LOSS VISUALIZATION.

NOTE:
- Single hidden layer (32 neurons) was used for UCI Iris with TriDENT.
- Train and save the model.
- Proceed with analysis similar to `loss_visualization.py`
"""
...
def train(
    ...
    print("--"*50)
    print(f"Training Sigmoid Network on UCI-Iris Dataset")
    print("--"*50)
    ...
    data['description'] = f"Sigmoid Network on UCI-Iris Dataset -- No extra metadata needed!"
    ...
    if checkpoint_flag:
        ...
        filename = f"sigmoid_model_acc{best_accuracy:.02f}_{today}.pkl"
